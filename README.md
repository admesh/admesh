...
Grab the 0.97.4 tarball:
https://github.com/admesh/admesh/releases/download/v0.97.4/admesh-0.97.4.tar.gz
...
````
================= Results produced by ADMesh version 0.97.4 =================
Input file         : sphere.stl
File type          : Binary STL file
Header             : Processed by ADMesh version 0.97.4
============== Size ==============
